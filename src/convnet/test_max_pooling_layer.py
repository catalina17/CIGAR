...
class TestMaxPoolingLayer(unittest.TestCase):
    ...
    def setUp(self):
        self.layer = MaxPoolingLayer((2, 2))
        self.layer_cuda = MaxPoolingLayerCUDA((2, 2))
    ...
    def test_back_prop(self):
        ...
        out_grad = np.array([[1, 1],
                             [1, 1]])
        expected_in_grad = np.array([[0, 0, 0, 2],
                                     [0, 4, 0, 0],
                                     [0, 0, 0, 4],
    ...
    def test_get_output_shape(self):
        ...
        self.assertEqual(self.layer.get_output_shape(), (140, 36))
        self.assertEqual(self.layer_cuda.get_output_shape(), (140, 36))
